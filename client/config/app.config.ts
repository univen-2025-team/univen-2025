...
export const appConfig = {
    ...
    seo: {
        ...
        description:
            'Nền tảng giao dịch chứng khoán hiện đại với công nghệ AI, phân tích thị trường real-time, và tư vấn đầu tư thông minh',
        keywords:
            'chứng khoán, đầu tư, cổ phiếu, thị trường, trading, stock market, VN30, HOSE, HNX',
