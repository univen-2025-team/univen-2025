...
export default function ProfilePage() {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            {/* Details Section */}
            <div className="relative rounded-2xl p-6 space-y-6 bg-white/20 backdrop-blur-2xl border border-white/20 shadow-xl ring-1 ring-white/10 transition-all duration-300">
          ...
          <ProfileDetailField
            label="Ngày sinh"
            value={displayProfileData.user_dayOfBirth 
              ? new Date(displayProfileData.user_dayOfBirth).toLocaleDateString('vi-VN')
              : 'Chưa cập nhật'}
            icon={
              <svg
                className="w-5 h-5"
                    ...
                    <ProfileDetailField
                        ...
                        value={
                            <span className="capitalize">
                                {displayProfileData.role_name || 'User'}
                            </span>
                        }
                        icon={
                            <svg
                            ...
                            <div className="flex items-center gap-2">
                                <div
                                    className={`w-3 h-3 rounded-full ${
                                        displayProfileData.user_status === 'ACTIVE'
                                            ? 'bg-green-500'
                                            : 'bg-red-500'
                                    }`}
                                ></div>
