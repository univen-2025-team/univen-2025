      ...
      <div className="relative z-10 max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 animate-scale-in">
          ...
          <div className="relative flex border-b border-gray-200 bg-gray-50">
            ...
            <div
              className={`absolute bottom-0 h-1 bg-primary transition-all duration-300 ease-out ${isLoginPage ? 'left-0 w-1/2' : 'left-1/2 w-1/2'
                }`}
            />
            ...
            <Link
              href="/auth/login"
              className={`flex-1 py-4 text-center font-semibold transition-all duration-300 relative ${isLoginPage ? 'text-primary' : 'text-gray-500 hover:text-gray-700'
                }`}
            >
            ...
            <Link
              href="/auth/register"
              className={`flex-1 py-4 text-center font-semibold transition-all duration-300 relative ${isRegisterPage
                  ? 'text-primary'
