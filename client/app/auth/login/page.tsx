...
import { loginUser, selectIsLoading, selectError, clearError } from '@/src/lib/store/authSlice';
...
export default function LoginPage() {
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="space-y-5">
      {/* Error Message */}
      {error && (
        <div className="bg-error border border-error text-white px-4 py-3 rounded-lg flex items-start">
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`block w-full pl-10 pr-3 py-3 border ${formik.touched.email && formik.errors.email
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={formik.handleChange}
            onBlur={formik.handleBlur}
            className={`block w-full pl-10 pr-3 py-3 border ${formik.touched.password && formik.errors.password
              ? 'border-error focus:ring-error'
              : 'border-gray-300 focus:ring-ring'
              } rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all text-gray-900 placeholder-gray-400`}
            placeholder="••••••••"
