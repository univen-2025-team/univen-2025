                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {achievements.map((achievement, index) => (
                            <div
                                key={index}
                                className="bg-[#0F111A]/80 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:border-yellow-500/30 transition-all duration-300 hover:shadow-[0_0_20px_-5px_rgba(234,179,8,0.2)] hover:-translate-y-1 cursor-pointer group"
                            >
                                <div className="text-5xl mb-4 group-hover:scale-110 transition-transform filter drop-shadow-lg grayscale group-hover:grayscale-0 duration-300">
                                    {achievement.icon}
                                </div>
                                ...
                                <div className="mt-4 px-3 py-1 bg-yellow-500/10 border border-yellow-500/20 rounded-lg text-xs font-bold text-yellow-500 inline-block shadow-[0_0_10px_rgba(234,179,8,0.1)]">
                                    ✓ Hoàn thành
                                </div>
                            </div>
                        ))}
