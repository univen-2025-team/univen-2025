        ...
        <div className="flex h-full flex-col gap-4">
            ...
            <div className="flex-1 space-y-3 overflow-auto pr-1">
                {displayItems.map((item) => (
                    <button
                        key={item.id}
                        className="w-full rounded-xl border border-white/10 bg-[#0F111A]/80 backdrop-blur-xl p-3 text-left transition hover:border-violet-500/40 hover:bg-white/5 ring-1 ring-white/5"
                    >
