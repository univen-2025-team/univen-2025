      ...
      <div className="flex flex-col gap-4 mb-6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors ${realtimeEnabled ? "bg-green-600 text-white hover:bg-green-700" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
              }`}
          >
        ...
        <div className="flex flex-wrap gap-2">
          {TIME_RANGES.map((range) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg font-medium text-sm transition-colors ${timeRange === range ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                }`}
            >
              {range}
            </button>
